...
import { animate, timeline as timeline2, stagger } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { stagger as stagger2 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { animate as animate2, stagger as stagger3, inView } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { inView as inView2 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { scroll } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { timeline as timeline3, inView as inView3 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { animate as animate3 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { animate as animate4 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";

// js/common/overlay/dialog-element.js
import { FocusTrap, Delegate } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { animate as motionAnimate, timeline as motionTimeline } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { animate as motionAnimate2, timeline as motionTimeline2 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { Delegate as Delegate2 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { animate as animate5 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { animate as animate6, timeline as timeline4, stagger as stagger4 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { Delegate as Delegate3 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { PhotoSwipeLightbox } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
var ProductGallery = class extends HTMLElement {
  ...
  get photoswipe() {
    ...
    const photoswipe = new PhotoSwipeLightbox({
      pswpModule: () => import("//www.ackerbaum.de/cdn/shop/t/83/assets/photoswipe.min.js?v=96595610301167188461721893329"),
      bgOpacity: 1,
...
import { animate as animate7, timeline as timeline5 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { inView as inView4 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
    ...
    if (this.hasAttribute("show-play-button") && !this.shadowRoot) {
      this.attachShadow({ mode: "open" }).appendChild(document.createRange().createContextualFragment(`
        ...
        <svg part="play-button" fill="none" width="48" height="48" viewBox="0 0 48 48">
          <path d="M48 24C48 10.745 37.255 0 24 0S0 10.745 0 24s10.745 24 24 24 24-10.745 24-24Z" fill="#f3f0ec"/>
          <path d="M18.578 32.629a.375.375 0 0 1-.578-.316V15.687c0-.297.328-.476.578-.316l12.931 8.314c.23.147.23.483 0 .63L18.578 32.63Z" fill="#311d0f"/>
          <path d="M24 .5C36.979.5 47.5 11.021 47.5 24S36.979 47.5 24 47.5.5 36.979.5 24 11.021.5 24 .5Z" stroke="#311d0f" stroke-opacity=".12"/>
        </svg>
      `));
    }
  }
...
import { timeline as timeline6 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { animate as animate8 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { animate as animate9 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
import { animate as animate10, inView as inView5 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
...
// js/theme.js
import { Delegate as Delegate4 } from "//www.ackerbaum.de/cdn/shop/t/83/assets/vendor.min.js?v=101728284033374364961721893329";
(() => {
